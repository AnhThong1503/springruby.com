...
import com.ruby.admin.setting.SettingService;
...
import com.ruby.common.entity.order.OrderTrack;
import com.ruby.common.entity.product.Product;
import com.ruby.common.entity.setting.Setting;
import com.ruby.common.exception.OrderNotFoundException;
...
public class OrderController {
	...
	public String viewOrderDetails(@PathVariable("id") Integer id, Model model, RedirectAttributes ra,
			HttpServletRequest request, @AuthenticationPrincipal RubyUserDetails loggedUser) {
		try {
